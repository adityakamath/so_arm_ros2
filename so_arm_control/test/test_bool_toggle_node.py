#!/usr/bin/env python3
"""
Node-level tests for bool_toggle_node.BoolToggle, plus pure-logic tests for its
correlate_service_event helper (TestCorrelateServiceEvent, no ROS node needed).
...
from so_arm_control.bool_toggle_node import BoolToggle, correlate_service_event
...
class TestCorrelateServiceEvent:
    """Pure-logic tests for bool_toggle_node.correlate_service_event - the SetBool service-event
    correlation used by emergency_stop's toggle, its only caller (see the module docstring)."""
