...
joint_state_switch_node, target_visualizer_node. None of these touch the actuation path or
need an isolated numpy ABI (unlike teleop_ik_node/joint_trajectory_bridge_node/
opencv_camera_node, which stay their own processes for exactly that reason) - sharing one
